...
function BasicDetailsManagement({}: Props) {
  ...
  return (
    <Grid container justifyContent="center">
      <Grid item xs={4} className="profileHeader">
        My <b>Profile</b>
      </Grid>
      <Grid item xs={6}>
      ...
      <Grid item xs={1} mt="70px" ml="20px">
        {Number(action) === Action.DETAILS ? (
          <IconButton
            component={NavLink}
            to={`${paths.PROFILE}?profileType=${ProfileType.BASIC}&action=${Action.UPDATE}`}
          >
...
export default BasicDetailsManagement;
